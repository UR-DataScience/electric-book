...
In this chpater we are going to learn about cmath library and its various mathematical functions that you could use. Also, we will take a look at characters, strings, and some functions that you can use when working with these two data types.

## **4.2 Mathematical Functions**

To use the following mathematical functions you need to include `cmath` library:
...
**Parameters**: 
- `x` - Value of a floating-point or integral type

**Return value**: If successful, returns the absolute value of `x` (\|`x`\|). The value returned is **exact** and does not depend on any rounding modes.

https://en.cppreference.com/w/cpp/numeric/math/fabs

### **log10 (x)**:
Computes common (base 10) logarithm of number `x`.

**Parameters**: 
- `x` - value of floating-point or Integral type

**Return value**: If no errors occur, the common (base-10) logarithm of `x` will be returned.
...
**Parameters**: 
- `x` - value of floating-point or Integral type
**Return value**: If no errors occur, the natural (base-e) logarithm of `x`.

<https://en.cppreference.com/w/cpp/numeric/math/log>

### **pow (x, y)**:
Raises a number to the given power (**x<sup>y</sup>**).

**Parameters**:

- `base` or `x` - base as a value of floating-point or integral type

- `exp` - exponent as a value of floating-point or inegral type
...
**Return value**: If no errors occur, base raised to the power of `exp` is returned.
...
**Return value**: If no errors occur, square root of `x`, is returned.
...
**Return value**: If no errors occur, the cubic root of `x`, is returned.
...
To use characters function you need to include ctype on the top of your code:
```cpp
#include <cctype> 
or
#include <ctype.h>
...
It combines the assignment and concatenation operations in the way
...
project as a text file in the Visual Studio C++.
